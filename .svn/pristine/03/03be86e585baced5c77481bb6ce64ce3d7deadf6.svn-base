...
SUITE(intersection_queries_perf) {
    ...
    TEST_FIXTURE(MapFixture, intersection_ids_from_street_names_perf) {
        ...
        expected = {3773};
        actual = find_street_ids_from_name("Bonnacord Drive");
        ...
        expected = {15108};
        actual = find_street_ids_from_name("Anderson Crescent");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {3411};
        actual = find_street_ids_from_name("Birchlea Avenue");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {12830};
        actual = find_street_ids_from_name("Bradstock Road");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {18549};
        actual = find_street_ids_from_name("Brickstone Mews");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {3631};
        actual = find_street_ids_from_name("Denton Avenue");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {10646};
        actual = find_street_ids_from_name("Dumfrey Road");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {12113};
        actual = find_street_ids_from_name("Dunera Avenue");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {15468};
        actual = find_street_ids_from_name("Father D'souza Drive");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        ...
        expected = {776};
        actual = find_street_ids_from_name("Howard Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {10712};
        actual = find_street_ids_from_name("Kidbrooke Crescent");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {10714};
        actual = find_street_ids_from_name("Montvale Drive");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {16078};
        actual = find_street_ids_from_name("Naomi Crescent");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {17849};
        actual = find_street_ids_from_name("National Pine Drive");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {9724};
        actual = find_street_ids_from_name("Parkham Crescent");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {20644};
        actual = find_street_ids_from_name("Pendulum Circle");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {3992};
        actual = find_street_ids_from_name("Rambert Crescent");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {1586};
        actual = find_street_ids_from_name("Ramp to Highway 407 E.T.R. Westbound");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {8864};
        actual = find_street_ids_from_name("Reith Way");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {12473,18258};
        actual = find_street_ids_from_name("Saffron Crescent");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {14024};
        actual = find_street_ids_from_name("Seminoff Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {1948};
        actual = find_street_ids_from_name("Shaftesbury Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {6966};
        actual = find_street_ids_from_name("South Parade Court");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {14337};
        actual = find_street_ids_from_name("Stargell Crescent");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {18747,18755};
        actual = find_street_ids_from_name("Strong Gate");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {16235};
        actual = find_street_ids_from_name("Tennyson Avenue");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {6535};
        actual = find_street_ids_from_name("To [107] Queen Street west");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {8571};
        actual = find_street_ids_from_name("Tomel Court");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {19477};
        actual = find_street_ids_from_name("Trentin Road");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);

        expected = {12048};
        actual = find_street_ids_from_name("Zaph Avenue");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {18641,18642,18702,18964,18965,19489};//corner case
        ...
        for(size_t i = 0; i < 900000; i++) {
            ...
            street_names.push_back(getStreetName(street_id1));
        }
        {
            //Timed Test
            ECE297_TIME_CONSTRAINT(950);
